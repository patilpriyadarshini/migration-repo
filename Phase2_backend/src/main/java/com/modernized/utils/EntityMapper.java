...
public class EntityMapper {
    ...
    public CardResponse mapToCardResponse(Card card) {
        ...
        if (card.getCardExpiraionDate() != null && card.getCardExpiraionDate().length() >= 7) {
            try {
    ...
    public void updateAccountFromRequest(Account account, AccountUpdateRequest request) {
    ...
    public void updateCardFromRequest(Card card, CardUpdateRequest request) {
